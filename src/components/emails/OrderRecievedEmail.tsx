...
const OrderReceivedEmail = ({
  ...
  const baseUrl =
    process.env.NODE_ENV === "development"
      ? "http://localhost:3000"
      : "https://case-cobra-topaz.vercel.app";
        ...
        <Container style={container}>
          <Section style={message}>
            ...
            <Text style={global.text}>
              We&lsquo;re preparing everything for delivery and will notify you
            ...
            <Text style={{ ...global.text, marginTop: 24 }}>
              ...
              to contact us with your order number and we&lsquo;re here to help.
            </Text>
          </Section>
          <Hr style={global.hr} />
          ...
          <Section style={paddingY}>
            <Row>
              ...
              >
                ...
                this email, we won&lsquo;t be able to see it.)
              </Text>
            </Row>
            <Row>
